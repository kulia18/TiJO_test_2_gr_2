...
var fragments = function (text)
{
    ...
    var mapping = {
        goodNewsText: element.bind(null,by.id('Milego dnia')),
        abcLabel: element.bind(null, by.id('Pozdrowienia')),
        cdeLabel: element.bind(null, by.id('uszanowanko')),
        input: element.bind(null, by.id('input'))
    };
